...
def get_result():
	# OpenAI API 키 설정
	api_key = "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"
	...
	response = openai.ChatCompletion.create(
		...
		messages=[
			...
			{"role": "user",
			 "content": f"다음 텍스트에서 회사명 : , 이름 : , 직책 : , 휴대폰번호 : , 주소 : , 이메일주소 : 만 간략히 정리후 없는 내용은 없음으로 표시해줘 그리고 이름은 한글이름만 표시해줘: \"{text2}\""}
		]
	)
